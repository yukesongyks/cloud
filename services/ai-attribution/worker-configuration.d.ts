/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be08e5502763076d55e7669650d47e81)
// Runtime types generated with workerd@1.20251210.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/ai-attribution.worker');
    durableNamespaces: 'AttributionTrackerDO';
  }
  interface Env {
    ENVIRONMENT: 'production' | 'development';
    ATTRIBUTION_TRACKER: DurableObjectNamespace<
      import('./src/ai-attribution.worker').AttributionTrackerDO
    >;
