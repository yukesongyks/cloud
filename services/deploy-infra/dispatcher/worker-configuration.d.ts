/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: 48e785083164ae9db5c7bac8b922086b)
// Runtime types generated with workerd@1.20260217.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		BANNER_LINK_URL: "https://app.kilo.ai/app-builder";
	}
	interface Env {
		DEPLOY_KV: KVNamespace;
		DISPATCH: DispatchNamespace;
		RATE_LIMITER: RateLimit;
		SESSION_DURATION_SECONDS: 604800 | 2592000;
		HOSTNAME_SUFFIX: ".d-staging.kiloapps.io" | ".d.kiloapps.io";
		BANNER_LINK_URL: "https://app.kilo.ai/app-builder";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_DURATION_SECONDS" | "HOSTNAME_SUFFIX" | "BANNER_LINK_URL">> {}
}
