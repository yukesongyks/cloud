/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: 9b9495253e8bc8271573f5668434e0f1)
// Runtime types generated with workerd@1.20251210.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'AppDbDO';
  }
  interface Env {
    DB_PROXY_ADMIN_TOKEN: string;
    APP_DB: DurableObjectNamespace<import('./src/index').AppDbDO>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'DB_PROXY_ADMIN_TOKEN'>> {}
}
