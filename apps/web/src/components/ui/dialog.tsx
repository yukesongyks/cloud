...
>(({ className, children, container, showCloseButton = true, ...props }, ref) => (
  <DialogPortal container={container}>
    ...
    >
      {children}
      {showCloseButton && (
        <DialogClose className="ring-offset-background data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 cursor-pointer rounded-sm opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
