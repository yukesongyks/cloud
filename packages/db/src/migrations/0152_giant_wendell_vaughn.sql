...
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "abuse_delay" integer;--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "abuse_downgraded_from" text;--> statement-breakpoint
