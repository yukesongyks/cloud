CREATE TABLE "api_kind" (
	"api_kind_id" serial PRIMARY KEY NOT NULL,
	"api_kind" text NOT NULL
);
--> statement-breakpoint
DROP VIEW "public"."microdollar_usage_view";--> statement-breakpoint
ALTER TABLE "microdollar_usage_metadata" ADD COLUMN "api_kind_id" integer;--> statement-breakpoint
CREATE UNIQUE INDEX "UQ_api_kind" ON "api_kind" USING btree ("api_kind");--> statement-breakpoint
